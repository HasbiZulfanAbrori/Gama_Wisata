            ...
            <div class="col-6">
                ...
                <div class="profile-text-bg mt-3">
                    <div class="profile-text">
                        PT Gama Wisata adalah badan usaha berbadan hukum dengan bentuk perseroan terbatas yang
                        berkedudukan di Yogyakarta yang bergerak di bidang biro perjalanan wisata. Lahir dan berkembang
                        dilingkungan kampus UGM Yogyakarta, PT Gama Wisata adalah anak perusahaan PT Gama Multi Usaha
                        Mandiri, sebuah holding Company yang merupakan entitas dari Universitas Gadjah Mada.
                    </div>
                </div>
                <div class="profile-text-bg mt-3">
                    <div class="visi-misi">Visi</div>
                    <div class="profile-text">
                        Menjadi penyedia pengalaman wisata edukasi yang terkemuka, khususnya untuk kalangan UGM dan
                        stakeholdernya
                    </div>
                </div>
                <div class="profile-text-bg mt-3">
                    ...
                    <div class="profile-text">
                        Memberikan layanan pada pelanggan dengan berorientasi pada kualitas yang prima dan harga yang
                        kompetitif
                    </div>
                </div>
            </div>
